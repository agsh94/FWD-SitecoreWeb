...
namespace FWD.Foundation.Logging.CustomSitecore
{
    ...
    public class LoggerJsonRenderer : AbstractLog
    {
        /// <summary>The syncronization object</summary>
        private readonly object syncObj = new object();
        /// <summary>The log.</summary>
        private static readonly LoggerJsonRenderer Instance = new LoggerJsonRenderer();
        /// <summary>The logger name.</summary>
        private const string LoggerName = "FWD.Foundation.CustomLoggerJsonRenderer";
        ...
        /// </summary>
        private LoggerJsonRenderer()
        {
        }

        /// <summary>Gets the log.</summary>
        public static LoggerJsonRenderer Log
        {
            get
            {
                return LoggerJsonRenderer.Instance;
            }
        }
        ...
        protected override ILog Log4NetLogger
        {
            get
            {
                if (this.logger == null)
                {
                    ...
                    {
                        if (this.logger == null)
                            this.logger = LogManager.GetLogger(LoggerName) ?? LoggerFactory.GetLogger(typeof(LoggerJsonRenderer));
                    }
                }
                return this.logger;
            }
