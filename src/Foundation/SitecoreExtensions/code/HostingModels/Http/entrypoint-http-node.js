...
/***/ function (module, exports, __webpack_require__) {
            ...
            server.listen(requestedPortOrZero, 'localhost', function () {
                ...
                console.log('[Sitecore.JavaScriptServices.ViewEngine.NodeServices.HttpNodeHost:Listening on {' + server.address().address + '} port ' + server.address().port + '\]');
                // Signal to the NodeServices base class that we're ready to accept invocations
                console.log('[Sitecore.JavaScriptServices.ViewEngine.NodeServices:Listening]');
            });
