...
Sitecore.Treeview.onTreeGlyphClick = function (node, treeElement, id) {
    ...
    if (glyph.src.indexOf("treemenu_collapsed.png") >= 0 && glyph.src.indexOf("notreemenu_collapsed.png.gif") == -1) {
        ...
        new Ajax.Request("/sitecore/shell/override/Controls/PublishTreeViewEx/PublishTreeViewEx.aspx?treeid=" + encodeURIComponent(treeElement.id) + "&id=" + encodeURIComponent(id) + (content != null ? "&sc_content=" + content : "") + contentLanguage, {
            method: "post",
            postBody: body,
