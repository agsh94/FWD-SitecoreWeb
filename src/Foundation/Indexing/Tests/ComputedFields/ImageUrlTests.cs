...
namespace FWD.Foundation.Indexing.Testing.ComputedFields
{
    public class ImageUrlTests
    {
        ...
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            // act
            var result = imageUrl.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = imageUrl.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            })
            {
                ...
                ReferenceField referenceField = item.Fields[NameLookupField.Image];
                ...
                // act
                var result = imageUrl.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
