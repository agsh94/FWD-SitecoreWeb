...
{
    public class AssociatedProductsTests
    {
        [Theory, AutoDbData]
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            var associatedProducts = new AssociatedProducts();

            // act
            var result = associatedProducts.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            using (Db db = new Db
            {
                ...
                {
                   new DbField(SearchConstant.AssociatedProducts) { Type = "Lookup" }
                },
            ...
            })
            {
                ...
                ReferenceField referenceField = item.Fields[new ID (SearchConstant.AssociatedProducts)];
                ...
                // act
                var result = associatedProducts.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = associatedProducts.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
