...
{
    public class CommonLocationFacilitiesTests
    {
        [Fact]
        public void Item_Null_Condition_Test()
        {
            // arrange
            var commonLocationFacilities = new CommonLocationFacilities();

            // act
            var result = commonLocationFacilities.ComputeFieldValue(null);
        ...
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            // act
            var result = commonLocationFacilities.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = commonLocationFacilities.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            })
            {
                ...
                // act
                var result = commonLocationFacilities.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
        ...
        public class ItemTemplate : DbTemplate
        {
            public ItemTemplate()
            {
                ...
                this.Add("commonLocationFacilities");
            }
        }
    }
}
