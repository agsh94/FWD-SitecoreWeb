...
namespace FWD.Foundation.Indexing.Testing.ComputedFields
{
    public class TopicsTests
    {
        ...
        public void Item_Null_Condition_Test()
        {
            ...
            // act
            var result = topics.ComputeFieldValue(null);
        ...
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            // act
            var result = topics.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = contentType.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
        ...
        [InlineData(SearchConstant.BaseFlexiTemplateID)]
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            using (Db db = new Db
            {
                ...
                {
                   new DbField(SearchConstant.Topics) { Type = "Lookup" }
                },
            ...
            })
            {
                ...
                ReferenceField referenceField = item.Fields[SearchConstant.Topics];
                ...
                // act
                var result = topics.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
