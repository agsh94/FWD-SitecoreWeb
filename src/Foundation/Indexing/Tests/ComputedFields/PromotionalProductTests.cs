...
{
    public class PromotionalProductTests
    {
        [Fact]
        public void Item_Null_Condition_Test()
        {
            // arrange
            var promotionalProduct = new PromotionalProduct();

            // act
            var result = promotionalProduct.ComputeFieldValue(null);
        ...
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            // act
            var result = promotionalProduct.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = promotionalProduct.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            })
            {
                ...
                // act
                var result = promotionalProduct.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
