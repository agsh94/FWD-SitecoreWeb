...
{
    public class PromotionalLabelTests
    {
        [Fact]
        public void Item_Null_Condition_Test()
        {
            // arrange
            var promotional = new PromotionalLabel();

            // act
            var result = promotional.ComputeFieldValue(null);
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            var promotionalLabel = new PromotionalLabel();

            // act
            var result = promotionalLabel.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            })
            {
                ...
                // act
                var result = promotionalLabel.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
