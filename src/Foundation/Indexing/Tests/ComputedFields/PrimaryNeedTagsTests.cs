...
{
    public class PrimaryNeedTagsTests
    {
        [Fact]
        public void Item_Null_Condition_Test()
        {
            // arrange
            var primaryNeedTags = new PrimaryNeedTags();

            // act
            var result = primaryNeedTags.ComputeFieldValue(null);
        ...
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            // act
            var result = primaryNeedTags.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        [InlineData(SearchConstant.BaseClaimTemplateID)]
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            using (Db db = new Db
            {
                ...
                {
                   new DbField(SearchConstant.PrimaryNeedTags) { Type = "Lookup" }
                },
            ...
            })
            {
                ...
                ReferenceField referenceField = item.Fields[SearchConstant.PrimaryNeedTags];
                ...
                // act
                var result = primaryNeedTags.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = primaryNeedTags.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
