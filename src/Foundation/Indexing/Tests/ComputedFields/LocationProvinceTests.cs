...
{
    public class LocationProvinceTests
    {
        [Fact]
        public void Item_Null_Condition_Test()
        {
            // arrange
            var locationProvince = new LocationProvince();

            // act
            var result = locationProvince.ComputeFieldValue(null);
        ...
        public void Item_Standard_Values_Condition_Test([Content] Item item)
        {
            ...
            // act
            var result = locationProvince.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(itemStdValues));
        ...
        public void Item_Base_Template_Condition_Test_True(string baseTemplateId)
        {
            ...
            using (Db db = new Db
            {
                ...
                {
                   new DbField(SearchConstant.ProvinceField) { Type = "Lookup" }
                },
            ...
            })
            {
                ...
                ReferenceField referenceField = item.Fields[new ID(SearchConstant.ProvinceField)];
                ...
                // act
                var result = locationProvince.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(item));
        ...
        public void Item_Base_Template_Condition_Test_False([Content] Item root, [Content] ItemTemplate template)
        {
            ...
            // act
            var result = locationProvince.ComputeFieldValue(new Sitecore.ContentSearch.SitecoreIndexableItem(anySitecoreItem));
