...
namespace FWD.Foundation.Indexing.ComputedFields
{
    ...
    public class LocationDistrict : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var districtField = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.LocationDistrictField)];
                return ComputedFieldHelper.GetTagValue(item, districtField);
            }
