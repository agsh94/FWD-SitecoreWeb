...
{
    public class ExpectedInsuranceType : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var expectedInsuranceTypeField = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.ExpectedInsuranceType)];
                return ComputedFieldHelper.GetTagValue(item, expectedInsuranceTypeField, SearchConstant.ListItemKey);
            }
            return null;
        }
    }
