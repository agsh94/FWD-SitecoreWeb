...
namespace FWD.Foundation.Indexing.ComputedFields
{
    ...
    public class FacilityType : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var ServiceFacilities = (MultilistField)item.Fields[new ID(SearchConstant.FacilitiesTypeField)];

                return ComputedFieldHelper.GetTagValue(item, ServiceFacilities);
            }
