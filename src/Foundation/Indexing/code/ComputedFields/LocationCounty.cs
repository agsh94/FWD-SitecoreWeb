...
namespace FWD.Foundation.Indexing.ComputedFields
{
    ...
    public class LocationCounty : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var countyField = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.LocationCountyField)];
                return ComputedFieldHelper.GetTagValue(item, countyField);
            }
