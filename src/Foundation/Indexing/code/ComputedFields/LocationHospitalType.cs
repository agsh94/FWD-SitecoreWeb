...
namespace FWD.Foundation.Indexing.ComputedFields
{
    ...
    public class LocationHospitalType : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var hospitalTypeField = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.LocationHospitalField)];
                return ComputedFieldHelper.GetTagValue(item, hospitalTypeField);
            }
