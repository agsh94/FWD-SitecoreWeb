...
namespace FWD.Foundation.Indexing.ComputedFields
{
    ...
    public class LocationOfficeType : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var officeTypeField = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.LocationOfficeField)];
                return ComputedFieldHelper.GetTagValue(item, officeTypeField);
            }
