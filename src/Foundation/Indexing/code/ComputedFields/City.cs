...
{
    public class City : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                var cityField = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.City)];
                return ComputedFieldHelper.GetTagValue(item, cityField);
            }
            return null;
        }
