...
{
    public class RiskDisclosure : AbstractComputedIndexField
    {
        ...
        public override object ComputeFieldValue(IIndexable indexable)
        {
            try
            {
                ...
                var dropLink = (GroupedDroplinkField)item.Fields[new ID(SearchConstant.RiskDisclosurePopup)];
            ...
            {
                Logger.Log.Error("Error while generating RiskDisclosure computed field " + ex);
