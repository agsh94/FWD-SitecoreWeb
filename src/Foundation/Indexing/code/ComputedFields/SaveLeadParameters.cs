...
{
    public class SaveLeadParameters : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                NameValueListField saveLeadParametersField = item?.Fields[new ID(SearchConstant.SaveLeadParameters)];
                return ComputedFieldHelper.GetNameValueList(item, saveLeadParametersField) ?? null;
            }
            return null;
        }
    }
