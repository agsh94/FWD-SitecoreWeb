...
namespace FWD.Foundation.Forms
{
    ...
    public class CustomSingleLineViewModel : StringInputViewModel
    {
        ...
        public string DialInCodeLength { get; set; }
        ...
        protected override void InitItemProperties(Item item)
        {
            ...
            DialInCodeLength = StringUtil.GetString(item.Fields[FormConstant.DialInCodeLength]);
        }
        protected override void UpdateItemFields(Item item)
        {
            ...
            item.Fields[FormConstant.DialInCodeLength]?.SetValue(DialInCodeLength, true);
        }
    }
}