...
{
    [Serializable()]
    public class CustomStepperViewModel : FieldViewModel
    {
        public string HelpText { get; set; }
        public string Label { get; set; }
        public string MinValue { get; set; }
        public string MaxValue { get;  set; }
        public string StepperInterval { get; set; }
        ...
        protected override void InitItemProperties(Item item)
        {
            ...
            StepperInterval = StringUtil.GetString(item.Fields[FormConstant.StepperInterval]);
        ...
        protected override void UpdateItemFields(Item item)
        {
            ...
            item.Fields[FormConstant.StepperInterval]?.SetValue(StepperInterval, true);
